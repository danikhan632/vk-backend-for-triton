...
struct LoadOpSPIRVConversion
  ...
  matchAndRewrite(triton::LoadOp op, OpAdaptor adaptor,
    ...
    for (size_t vecStart = 0; vecStart < numElems; vecStart += vec) {
      ...
      Value ptrElem = bitcast(ptrElems[vecStart], ptr_ty(retTy, spirv::StorageClass::StorageBuffer));
...
struct StoreOpSPIRVConversion
  ...
  matchAndRewrite(triton::StoreOp op, OpAdaptor adaptor,
    ...
    for (size_t vecStart = 0; vecStart < elemsPerThread; vecStart += vec) {
      ...
      Value ptrElem = bitcast(ptrElems[vecStart], ptr_ty(valueVectorTy, spirv::StorageClass::StorageBuffer));
...
struct AtomicRMWOpSPIRVConversion
  ...
  matchAndRewrite(triton::AtomicRMWOp op, OpAdaptor adaptor,
    ...
    for (size_t i = 0; i < elemsPerThread; i += vec) {
      ...
      Value ptrElem = bitcast(rmwPtr, ptr_ty(retType, spirv::StorageClass::StorageBuffer));
      Value ret;
